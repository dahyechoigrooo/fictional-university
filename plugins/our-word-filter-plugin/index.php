...
class OurWordFilterPlugin {
    ...
    function replacementFieldHTML() { ?>
        ...
        <p class="description">Leave blank to simply remove the filter words.</p>
    <?php }
    ...
    function ourMenu() {
        // add_menu_page('Words To Filter', 'Word Filter', 'manage_options', 'ourwordfilter', array($this, 'wordFilterPage'), plugin_dir_url(__FILE__).'custom.svg', 100); // use icon's color
        ...
        // 플러그인의 메인페이지(부모페이지)를 불러올 때 css 파일을 불러오는 함수를 호출.
        // 메인페이지(부모페이지) 앞에 load를 붙이면 hook으로 사용할 수 있다.
